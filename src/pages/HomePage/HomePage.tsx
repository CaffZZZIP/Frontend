...
// function getRoutineTypeFromName(name?: string): RoutineType {
//   const value = (name || "").toUpperCase();

//   if (value.includes("WEEKEND") || value.includes("REST") || value.includes("쉬") || value.includes("휴")) {
//     return "WEEKEND";
//   }
